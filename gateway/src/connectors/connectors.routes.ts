...
import { LfgswapConfig } from './lfgswap/lfgswap.config';
    ...
    asyncHandler(async (_req, res) => {
      res.status(200).json({
        connectors: [
          ...
          {
            name: 'lfgswap',
            trading_type: LfgswapConfig.config.tradingTypes,
            available_networks: LfgswapConfig.config.availableNetworks,
          },
        ],
      });
    })
